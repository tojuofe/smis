...
// JS
import { editModalClose } from '../../js/main.js';
import { createReport } from '../../../action/report';

const ResultSubject = ({ current, createReport, subjects }) => {
...
export default connect(mapStateToProps, mapDispatchToProps)(ResultSubject);
